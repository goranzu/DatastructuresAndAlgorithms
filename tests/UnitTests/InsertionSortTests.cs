...
public class InsertionSortTests
{
    ...
    [Fact]
    public void insertion_sort_should_correctly_sort_an_unsorted_array()
    {
    ...
    [Fact]
    public void insertion_sort_should_not_modify_an_already_sorted_array()
    {
    ...
    [Fact]
    public void insertion_sort_should_sort_descending_lists()
    {
    ...
    [Fact]
    public void insertion_sort_should_sort_ascending_lists()
    {
    ...
    [Fact]
    public void insertion_sort_should_sort_float_lists()
    {
    ...
    [Fact]
    public void insertion_sort_should_sort_empty_lists()
    {
    ...
    [Fact]
    public void insertion_sort_should_sort_single_element_lists()
    {
        int[] testData = [1];
        SortingAlgorithms.InsertionSort(testData);
    ...
    [Fact]
    public void insertion_sort_should_sort_single_null_lists()
    {
    ...
    [Fact]
    public void insertion_sort_should_sort_list_with_int_and_null()
    {
